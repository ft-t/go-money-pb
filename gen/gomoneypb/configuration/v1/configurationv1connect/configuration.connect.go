...
const (
	...
	ConfigurationServiceName = "gomoneypb.configuration.v1.ConfigurationService"
)
...
const (
	...
	ConfigurationServiceGetConfigurationProcedure = "/gomoneypb.configuration.v1.ConfigurationService/GetConfiguration"
)
...
// ConfigurationServiceClient is a client for the gomoneypb.configuration.v1.ConfigurationService
// service.
...
// gomoneypb.configuration.v1.ConfigurationService service. By default, it uses the Connect protocol
...
// GetConfiguration calls gomoneypb.configuration.v1.ConfigurationService.GetConfiguration.
...
// gomoneypb.configuration.v1.ConfigurationService service.
...
func NewConfigurationServiceHandler(svc ConfigurationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gomoneypb.configuration.v1.ConfigurationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedConfigurationServiceHandler) GetConfiguration(context.Context, *connect.Request[v1.GetConfigurationRequest]) (*connect.Response[v1.GetConfigurationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gomoneypb.configuration.v1.ConfigurationService.GetConfiguration is not implemented"))
}
